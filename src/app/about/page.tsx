          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white rounded-lg shadow-sm p-6 text-center hover:shadow-md transition-shadow">
              <div className="w-14 h-14 bg-pink-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <Factory className="w-7 h-7 text-pink-500" />
              </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
            {[
              ...
              <div
                key={index}
                className="bg-gray-50 rounded-lg p-4 text-center hover:bg-pink-50 transition-colors"
              >
                <CheckCircle className="w-5 h-5 text-pink-500 mx-auto mb-2" />
